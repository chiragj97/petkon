...
const activedrawerColor = "#29489A";
...
const primaryColor = ["#0B2559", "#1D7FD1"];
const warningColor = ["#ff9800", "#ffa726"];
const dangerColor = ["#f44336", "#ef5350"];
const successColor = ["#4caf50", "#66bb6a"];
const infoColor = ["#00acc1", "#26c6da"];
const roseColor = ["#e91e63", "#ec407a"];
const grayColor = [
  "#999",
  "#777",
  "#3C4858",
...
const warningCardHeader = {
  background: "linear-gradient(60deg, #dd972f , #dd972f)",
  ...warningBoxShadow,
};
const successCardHeader = {
  background: "linear-gradient(60deg, #60a767, #60a767)",
  ...successBoxShadow,
};
...
const infoCardHeader = {
  background: "linear-gradient(60deg, #99a249, #99a249)",
  ...infoBoxShadow,
};
const primaryCardHeader = {
  background: "linear-gradient(60deg, #8f959b, #8f959b)",
  ...primaryBoxShadow,
};
...
const getMuiTheme = () =>
  createMuiTheme({
    ...
    overrides: {
      MUIDataTable: {
        paper: {
          boxShadow: "0 3px 10px 0 #0000000f !important",
