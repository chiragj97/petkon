...
export default function AdminNavbarLinks({ logout, name }) {
  ...
  return (
    <div>
      <div className={classes.searchWrapper}>
        <div
          style={{ background: "#FFFFFF", color: "#0B2559", border: "1px solid #0B2559", padding: "0px" }}
          className="inventory-Searchbox-container"
        >
